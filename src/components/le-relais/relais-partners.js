...
const RelaisPartners = () => {
    const data = useStaticQuery(graphql `
    query relaisPartners {
        ...
        relais: file(relativePath: {eq: "partners/relais.png"}) {
          childImageSharp {
...
`);
    ...
    const relais = data.relais.childImageSharp.gatsbyImageData;
