...
const TremblantExtra = () => {
    const data = useStaticQuery(graphql `
    query tremblantExtra{
      backgroundOne: file(relativePath: {eq: "covid-tremblant.jpg"}) {
        childImageSharp {
          gatsbyImageData(layout: CONSTRAINED)
        }
      }
      backgroundTwo: file(relativePath: {eq: "tremblant-wc.jpg"}) {
        childImageSharp {
          gatsbyImageData(layout: CONSTRAINED)
        }
      }
