...
const TremblantForm = () => {
    ...
    return (
        <div id="tremblant-form" className="grid bg-light px-10 py-6">
            <h2 className="my-4 text-white text-2xl">
                <FormattedMessage id="contact.get_in_touch"/>
            </h2>
            <div className="flex">
                <div className="w-full">
                    {submitText && <p className="text-white bg-fcPurple text-center p-1 mb-4">{submitText}</p>}
                    {submitText
                        ? null
                        : <form
                            name="tremblant-contact"
                            method="post"
                            data-netlify="true"
