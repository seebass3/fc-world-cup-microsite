        ...
        <section id="partners" className="shadow-lg pt-4">
            ...
            <div className="mx-auto px-4">
                <div
                    ...
                    <a href="https://www.flagsunlimited.com/" rel="noopener noreferrer" to target="_blank"><GatsbyImage image={flags} alt="Flags Unlimited Logo"/></a>
                    <a href="https://www.canadasnowboard.ca/en/" rel="noopener noreferrer" to target="_blank"><GatsbyImage image={snowboard} alt="Canada Snowboard Logo"/></a>
                    <a href="https://www.alberta.ca/index.aspx" rel="noopener noreferrer" to target="_blank"><GatsbyImage image={alberta} alt="Alberta Logo"/></a>
                    <a href="https://www.canada.ca/home.html" rel="noopener noreferrer" to target="_blank"><GatsbyImage image={canada} alt="Canada Logo"/></a>
                    <a href="http://www.winsportcanada.ca/" rel="noopener noreferrer" to target="_blank"><GatsbyImage image={winsport} alt="Winsport Logo"/></a>
                    <a href="https://www.visitcalgary.com/" rel="noopener noreferrer" to target="_blank"><GatsbyImage image={calgary} alt="Calgary Logo"/></a>
